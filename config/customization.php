...
// Funktion zur Bereinigung der Eingaben (schützt vor XSS)
      ...
      <form action="customization.php?preset_id=<?= $presetData['id']; ?>" method="POST">
        ...
        <div class="bg-gray-800 p-6 rounded-lg shadow-md mb-6">
          ...
          <div class="flex items-center">
            ...
            <label for="active" class="ml-2 text-lg font-medium">Preset aktivieren</label>
          </div>
        </div>
        ...
        <div class="bg-gray-800 p-6 rounded-lg shadow-md mb-6">
          ...
          <div class="flex items-center mb-4">
            ...
            <label for="bg_image_enabled" class="ml-2 text-lg">Hintergrundbild aktivieren</label>
          </div>
          <div class="mb-4">
        ...
        <div class="bg-gray-800 p-6 rounded-lg shadow-md mb-6">
          ...
          <div class="flex items-center mb-4">
            ...
            <label for="dark_mode_switch_enabled" class="ml-2 text-lg">Dark Mode Switch anzeigen</label>
          </div>
          <div class="mb-4">
            <label for="default_mode" class="block text-lg font-medium mb-1">Standardmodus</label>
